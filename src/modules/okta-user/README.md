...
| <a name="input_kms_alias_name"></a> [kms\_alias\_name](#input\_kms\_alias\_name) | The name of the KMS alias used for encryption/decryption of SSM parameters (API key) | `string` | `"alias/aws/ssm"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_ssm_prefix"></a> [ssm\_prefix](#output\_ssm\_prefix) | Where to find the AWS API key information for the user |
